		...
		<div class="flexbox-wrapper">
			...
			<div class="body dashboard-flex">
				<div class="sidebar">
					...
					<div id="owners" class="sidebar-btn active-btn">
				...
				<div class="page-content">
					...
					<!-- Begin Connection of Analytics -->	
						<div class="userbox2">
							<h1>WhereHouse Owners Master List</h1>
							<style>
								table{
									width:100%;
									text-align: center;
							...
							<?php
								...
								if ($conn->connect_error) {
									...
									$sqli = "SELECT owner_id, company_name, bank_acc, routing_num FROM Owner";
								...
								if ($resulti->num_rows > 0) {
										...
										while($row1 = $resulti->fetch_assoc()) {
											...
											$bank = $row1['bank_acc'];
											$routing = $row1['routing_num'];
											
											$sql2 = "SELECT * FROM User WHERE id = $OID";
							...
							echo "There are no Owners";
									...
									if($result->num_rows > 0) {
										while($row = $result -> fetch_assoc()){
											echo "<tr>
											<td scope='col'>". $row["id"] ."
											<td scope='col'>". $row["first_name"] ."
											<td scope='col'>". $row["last_name"] ."
											<td scope='col'>". $row["phone_num"] ."
											<td scope='col'>". $row["email"] ."</td>										
											<td scope='col'>". $row["dob"] ."</td>
											<td scope='col'>". $row["address_1"] ."</td>
											<td scope='col'>". $row["city"] ."</td>
											<td scope='col'>". $row["state"] ."
											<td scope='col'>". $row["zipcode"] ."
											</td></tr>";
										}
										echo "</table>";
									}
