...
.attribute{
  ...
  box-sizing: border-box;
	...
	<body>
		...
		<div class="userbox">
			<div class="service2">
			<img src='https://avataaars.io/?avatarStyle=Circle&topType=ShortHairShortWaved&accessoriesType=Wayfarers&hairColor=BrownDark&facialHairType=BeardLight&facialHairColor=Blonde&clotheType=Hoodie&clotheColor=Gray01&eyeType=Close&eyebrowType=UnibrowNatural&mouthType=Smile&skinColor=Yellow'
			style="width:100pt"/>			
			</div>

			<div class="service2">
			<!-- Replace with the user's actual name -->
			<h1><b>John Doe<b></h1>
			
			<!-- Replace with the user's actual email -->
			<h5>john.doe@purdue.edu</h5>	
			</div>
