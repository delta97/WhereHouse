<?php
	...
	$query = "SELECT contract_id, start_date, end_date, warehouse_id, total_price FROM Contract WHERE lessee_id = $user_id AND status = 'Active'";
