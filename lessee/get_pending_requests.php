<?php
	...
	$query = "SELECT * FROM Contracts WHERE Lessee_id = $user_id AND Status = 'Pending' ORDER BY start_date DESC";
	...
	if($num_requests > 0) {
		...
		echo"<h2 style=\"padding-top:40px; text-align:center;\">You don't have any pending warehouse rental requests.</h2>";
	}
